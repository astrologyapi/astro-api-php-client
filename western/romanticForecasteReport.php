...
/*
 * First parameter is the name of the api : ex. romantic_forecast_couple_report/tropical
 * Second parameter is the request data to be sent for calculation
 */

$apiResponse = $astrologyApi->callApi('romantic_forecast_couple_report/tropical', $sampleRequest);
